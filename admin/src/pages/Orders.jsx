    ...
    <div>
      ...
      <div>
        {orders.map((order, index) => (
          <div
            key={index}
            className="grid grid-cols-1 sm:grid-cols-[0.5fr_2fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr_0.5fr] 
          ...
          >
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-md font-medium transition-all"
            >
              Delete
            </button>
          </div>
